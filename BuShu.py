...
extensions_to_clone = [
    ...
    (f"https://github.com/dtlnor/{a}-{d}-{w}-localization-zh_CN", f"{extensions_path}/{a}-{d}-{w}-localization-zh_CN"),
    (f"https://github.com/hanamizuki-ai/{a}-{d}-{w}-localization-zh_Hans", f"/extensions/{a}-{d}-{w}-localization-zh_Hans"),
    ...
    (f"https://github.com/journey-ad/sd-webui-bilingual-localization", f"{extensions_path}/sd-{w}-bilingual-localization"), 
    (f"https://github.com/etherealxx/batchlinks-webui", f"{extensions_path}/extensions/batchlinks-{w}"), 
